...
data %>%  
    ...
    mutate(across(c(age, match_age), ~ na_if(., 99))) %>%  
...
![](basic-research-methods_files/figure-pptx/plot-1.png)<!-- -->
...
![Fishbone diagram showing women's expectation on first date](basic-research-methods_files/figure-pptx/fishbone-1.png)
